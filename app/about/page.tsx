    ...
    return <div className="min-h-screen bg-[#111318] text-white">
        <section className="border-b border-white/10">
            <div className="max-w-5xl mx-auto px-6 py-20 sm:py-28 flex flex-col md:flex-row items-start gap-10 md:gap-14">
                <div className="relative w-32 h-32 sm:w-40 sm:h-40 rounded-2xl overflow-hidden border-2 border-[#b8f23a]/50 flex-shrink-0"><Image src="/bernard22.png" alt="Bernady Krzysztof" fill className="object-cover object-top" /></div>
