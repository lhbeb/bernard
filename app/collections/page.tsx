...
export default function CollectionsPage() {
    return (
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 text-center">
            <div className="w-16 h-16 rounded-2xl bg-[#39ff8a]/10 border border-[#39ff8a]/25 flex items-center justify-center mx-auto mb-6">
                <Box size={28} className="text-[#39ff8a]" />
            </div>
            ...
            <Link href="/" className="inline-flex items-center gap-2 text-sm text-[#39ff8a] hover:underline">
